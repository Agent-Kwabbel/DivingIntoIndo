    ...
    return (
        <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
            ...
            <nav className="sm:ml-auto flex items-center gap-4 sm:gap-6">
                <Link href="/home/terms" className="text-xs hover:underline underline-offset-4">Terms of Service</Link>
                <Link href="/home/privacy" className="text-xs hover:underline underline-offset-4">Privacy</Link>
